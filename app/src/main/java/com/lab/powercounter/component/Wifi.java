...
//                interfaceName + "/statistics/rx_bytes";
    ...
    private static class WifiStateKeeper {
        ...
        public WifiStateKeeper(double highLowTransition, double lowHighTransition) {
            this.highLowTransition = highLowTransition;     //低于low是属于wifi low-power state 一般是8 packets
            this.lowHighTransition = lowHighTransition;     //高于high是属于wifi high-power state 一般是15 packets
